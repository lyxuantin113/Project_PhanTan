...
public class DSHoaDon_Gui extends JPanel implements ActionListener, MouseListener {
	...
	public DSHoaDon_Gui() throws RemoteException {
//		JPANEL
...
//		END
		...
		hoaDonDao = new HoaDon_Impl();
		cthdDao = new ChiTietHoaDon_Impl();
	...
	public void hienTableHoaDon() {
		...
		List<HoaDon> listHoaDon = hoaDonDao.findAll();
		if (listHoaDon != null) {
			for (HoaDon hoaDon : listHoaDon) {
				Object[] rowData = { hoaDon.getMaHoaDon(), hoaDon.getMaNhanVien().getMaNhanVien(), hoaDon.getMaKhachHang().getTenKhachHang(),
						hoaDon.getMaKhachHang().getSoDienThoai(), hoaDon.getNgayLap(), hoaDon.getNgayNhan(),
			...
			if (typeSearch.equalsIgnoreCase("Mã đơn")) {
				...
				if (listHD != null) {
					...
					for (HoaDon hoaDon : listHD) {
						Object[] rowData = { hoaDon.getMaHoaDon(), hoaDon.getMaNhanVien().getMaNhanVien(),
								hoaDon.getMaKhachHang().getTenKhachHang(), hoaDon.getMaKhachHang().getSoDienThoai(), hoaDon.getNgayLap(),
